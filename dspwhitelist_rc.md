...
* _**account name**_ (name of the party invoking this contract)

### Intent

INTENT. The intent of the author and invoker of this contract is to store and manage account whitelising for DSPs.
